    ...
    <div class="container mt-3">
        <div class="row d-flex justify-content-between">
            <div class="col-md-3 col-sm-12 bg-light organization-filter p-3">
                ...
                <a href="/addOrganizationRequest"><button class="submit-btn mt-3"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="currentColor" class="bi bi-building-add"
                            viewBox="0 0 16 16">
                            <path
