    ...
    <div class="container mt-3">
        <div class="row d-flex justify-content-between">
            ...
            <div class="col-md-9 col-sm-12">
                <div class="widthed bg-light p-3">
                    @foreach ($organizations as $organization)
                        <div class="organization-card mb-3">
                            <div class="row p-3">
                                <div class="col-3">
                                    <img src="{{ $organization->image }}" class="organization-img">
                                </div>
                                <div class="col-9">
                                    <div class="">
                                        <h5 class="col d-inline">{{ $organization->name }}</h5>
                                        ...
                                        @endif
                                        <br>
                                        <sub class="text-secondary">{{ $organization->category }}</sub>
                                    </div>
                                    ...
                                    <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        </svg>{{ $organization->contact_phone }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
